...
btn_access = text("Місце/Доступ")
btn_unblock_inet = text("Розблокувати інет")
...
require_group_member_text = text(
    "🚫",
    "{}, дана команда та функціонал Вам не доступні.",
    "Ваш ID не належить списку ALLOWED_CHAT_IDS або CHAT_SUPPORT_ID.",
)
...
# DUTY.PY
not_found_duty_users = text("Чергувальників не назначено в системі")
msg_duty_chat = text(
